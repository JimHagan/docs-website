...
<Callout variant="tip">
For an advanced deep dive into managing data ingest in a complex organization see the [data governance module of our observability maturity program](/docs/new-relic-solutions/observability-maturity/operational-efficiency/-data-governance).
</Callout>telemetry
