...
## Framework Definitions and Practices

<CollapserGroup>
  <Collapser
    id="data-governance-framework-summary"
    title="Formal Framework Definition"
    >
...
[Lucidchart Link](https://lucid.app/documents/view/c8f7c004-ec86-4ec2-ac1f-06a88c41ab52)
  ...
  <Collapser
    ...
    title="Telemetry Ingest Drivers"
    >
...
<Collapser
    ...
    title="Roles and Responsibiliities"
  >
...
<Collapser
    ...
    title="Enforcing Consitency and Quality"
  >
...
[Alert on Data Ingest Anomalies](http://localhost:8000/docs/accounts/accounts-billing/new-relic-one-pricing-billing/usage-queries-alerts/)

[View System Limits](https://docs.newrelic.com/docs/data-apis/manage-data/query-limits/)

[Tracking Ingest Errors With NrIntegrationError](https://docs.newrelic.com/docs/data-apis/manage-data/query-limits/)

[Tracking Query Limits](https://docs.newrelic.com/docs/data-apis/manage-data/query-limits/)

[Calculate Data Ingest](https://docs.newrelic.com/docs/data-apis/manage-data/calculate-data-ingest/)
