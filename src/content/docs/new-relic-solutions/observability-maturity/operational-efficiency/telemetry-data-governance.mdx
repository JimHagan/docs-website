...
- Transition to a value first approach
...
- What value quadrant(s) does it support.
...
## Data Governance Framework Summarized
...
<Collapser
    ...
    title="Telemetry Standards Guide: Enforcing Consitency and Quality"
  >
