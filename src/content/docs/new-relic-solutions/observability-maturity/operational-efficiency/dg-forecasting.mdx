...
### Looking more closel at growth drivers
...
If we determine that there is a misalignment between our forecast and actual ingest target we recommend you call an *Ad Hoc Anomaly* session with your data governance team.  That is the proper former for choosing a course of action.  Fundamentally there are a handful of actions that could be warranted:
