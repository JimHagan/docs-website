...
I see from the results there is a high volume of metrics of the pattern `aws.rds.cpu%`.  Let's drop those since we have other insrtrumentation for those.
...
<Collapser
  ...
  title="Optimization With Sampling and Transformation"
>
<CollapserGroup>
<Collapser
  id="compression"
