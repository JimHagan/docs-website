...
<div><img src={optimizingicon} alt="Optimize" style={{ height: '96px', width: '120px', verticalAlign: 'middle', horizontalAlign: 'right'}} /></div>
...
Data volume will also vary based on whether you are using `infinite tracing` or not.
