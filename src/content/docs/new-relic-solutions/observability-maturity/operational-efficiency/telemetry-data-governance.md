...
1. What group within the organization configured this telemetry
2. What platform or application does it monitor
3. What are the growth characteristics of this data
4. Does value quadrant(s) does it support.
...
- Baseline Budget Planning Session
  - Ensure that faceline fact reports are known, shared and agreed upon
