---
title: Developing & Adopting Telemetry Standards
tags:
...
## Why do we need data governance? [#why-data-governance]
...
## Framework Definition and Practices [#framework-details]
...
### Telemetry SMEs
*Scope*: Multiple as needed within the organization.  May be focused on a technical domain or platform but may also be a generalist.
...
- Contributes to the Telemetry Standards Guide where possible especially in helping optimize configurations, and improving metadata standards 
  ...
  <Collapser
    ...
    title="Prerequisite Work: Understanding Telemetry Cost Drivers"
    >

This section will highly issues that should be understood in order properly assess your environments to understand proactively where growth can come from.  These costs are incurred at each stage of the data pipeline and include

- Collection
- Transmission and Transformation
- Persistence and Retrieval

The items discussed below can generally be mapped to one of those three main stages of the telemetry lifecycle.
...
<Collapser
    id="partnering-with-newrelic"
    title="DG in Practice: Partnering With New Relic"
 >
