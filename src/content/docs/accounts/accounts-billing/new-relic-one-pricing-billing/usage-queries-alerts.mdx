...
<CollapserGroup>
  ...
  <Collapser
    ...
    title="Projected monthly full platform user count"
  >
  ...
  <Collapser
    id="full-basic-users"
    title="Count full platform users and basic users"
  >
...
<Callout variant="tip">
For an advanced deep dive into managing data ingest in a complex organization see the [data governance module of our observability maturity program](/docs/new-relic-solutions/observability-maturity/operational-efficiency/telemetry-data-governance).
</Callout>
